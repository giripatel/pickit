...
const Alert = ({ onClick, description }: { onClick: () => void, description : string }) => {
  return (
    <div>
      <AlertDialog>
        <AlertDialogTrigger
          ...
          <AlertDialogHeader> 
            <AlertDialogTitle className="flex gap-1">
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                className=" text-green-500 mt-1 rounded-full w-5 h-5"
              >
                <path
            ...
            <AlertDialogDescription className="text-gray-900">
             <span className="text-md font-semibold me-2">Item:</span> {description}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
